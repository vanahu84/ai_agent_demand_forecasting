...
python /app/ai_agent_demand_forecasting/drift_detection_mcp_server.py --help > /dev/null 2>&1 || echo "⚠️  MCP server test failed - continuing anyway"

echo "🌐 Starting ADK MCP server..."
adk web --host 0.0.0.0 --port "${PORT:-10000}"
